Module modBillToClient
    ...
    Private Function AddInvoice_CreditNote_ForLive(ByVal sFileName As String, ByVal odv As DataView, ByRef sErrDesc As String) As Long

        Dim sFuncName As String = "AddInvoice_CreditNote_ForLive"
        ...
        Try
                ...
                If Not odv(i)(2).ToString = String.Empty Then
                    ...
                    If Not (odv(i)(13).ToString = String.Empty) Then
                        ...
                        If (CDbl(odv(i)(13).ToString.Trim() <> 0)) Then
                            ...
                            If Not (odv(i)(18).ToString.Trim() = String.Empty) Then
                                If (odv(i)(18).ToString.Trim = 0) Then
                                    oDoc.Lines.VatGroup = p_oCompDef.sARZeroRated
                                ElseIf (odv(i)(18).ToString.Trim = 7) Then
                                    oDoc.Lines.VatGroup = p_oCompDef.sARStdRated
                                Else
                                    oDoc.Lines.VatGroup = p_oCompDef.sARZeroRated
                                End If
                    ...
                    If Not (odv(i)(15).ToString = String.Empty) Then
                        If (CDbl(odv(i)(15).ToString.Trim() <> 0)) Then
                            ...
                            dtItemCode.DefaultView.RowFilter = "Name = 'TPA - FFS'"
                            If dtItemCode.DefaultView.Count = 0 Then
                                sErrDesc = "ItemCode ::'TPA - FFS' Others provided does not exist in SAP(Mapping Table) for TPA-OTHERS."
                                Call WriteToLogFile(sErrDesc, sFuncName)
                                Throw New ArgumentException(sErrDesc)
                            Else
                                sItemCode = dtItemCode.DefaultView.Item(0)(0).ToString().Trim()
                            ...
                            If Not (sCostCenter = String.Empty) Then
                                ...
                                oDoc.Lines.COGSCostingCode = sCostCenter
                            End If
                            If Not (p_oCompDef.sTpaOthersGlCode = String.Empty) Then
                                oDoc.Lines.AccountCode = p_oCompDef.sTpaOthersGlCode
                            End If
                    ...
                    If Not (odv(i)(16).ToString = String.Empty) Then
                        If (CDbl(odv(i)(16).ToString.Trim() <> 0)) Then
                            If iCount > 1 Then
                                oDoc.Lines.Add()
                            End If
                            ...
                            dtItemCode.DefaultView.RowFilter = "Name = 'TPA - FFS'"
                            If dtItemCode.DefaultView.Count = 0 Then
                                sErrDesc = "ItemCode ::'TPA-FFS' processing fees provided does not exist in SAP(Mapping Table)."
                                Call WriteToLogFile(sErrDesc, sFuncName)
                                Throw New ArgumentException(sErrDesc)
                            Else
                                sItemCode = dtItemCode.DefaultView.Item(0)(0).ToString().Trim()
                            ...
                            End If
                            oDoc.Lines.ItemCode = sItemCode
                            oDoc.Lines.UnitPrice = Math.Abs(CDbl(odv(i)(16).ToString.Trim()))
                            oDoc.Lines.VatGroup = sVatGroup
                            If Not (sCostCenter = String.Empty) Then
                                oDoc.Lines.CostingCode = sCostCenter
                                oDoc.Lines.COGSCostingCode = sCostCenter
                            End If
                            If Not (p_oCompDef.sTpaProcFeeGlCode = String.Empty) Then
                                oDoc.Lines.AccountCode = p_oCompDef.sTpaProcFeeGlCode
                            End If
                    ...
                    If bIsPanel = False Then
                        ...
                        If Not (odv(i)(17).ToString = String.Empty) Then
                            If (CDbl(odv(i)(17).ToString.Trim() <> 0)) Then
                                If iCount > 1 Then
                                    oDoc.Lines.Add()
                                End If
                                ...
                                End If
                                oDoc.Lines.ItemCode = sItemCode
                                oDoc.Lines.UnitPrice = Math.Abs(CDbl(odv(i)(17).ToString.Trim()))
                                oDoc.Lines.VatGroup = sVatGroup
                                If Not (sCostCenter = String.Empty) Then
                                    oDoc.Lines.CostingCode = sCostCenter
                                    oDoc.Lines.COGSCostingCode = sCostCenter
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            AddInvoice_CreditNote_ForLive = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message.ToString
            Call WriteToLogFile_Debug(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            AddInvoice_CreditNote_ForLive = RTN_ERROR
        End Try
