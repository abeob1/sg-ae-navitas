...
Public Module modLogging
    ...
    Public sBINLocation As String = String.Empty
   
    Public P_sConString As String = String.Empty
    Public P_sSAPConString As String = String.Empty
    Public P_sStagingDBName As String = String.Empty
    Public P_sSAPDBName As String = String.Empty
    Public P_sPriceListName As String = String.Empty
    ...
    'Company Connection Varaibles:
    Public p_sServerName As String = String.Empty
    Public p_sLicServerName As String = String.Empty
    Public p_sDBUserName As String = String.Empty
    Public p_sDBPassword As String = String.Empty
    Public p_sSQLType As Int16
    Public p_sDataBaseName As String = String.Empty
    Public p_sSAPUserName As String = String.Empty
    Public p_sSAPPassword As String = String.Empty
