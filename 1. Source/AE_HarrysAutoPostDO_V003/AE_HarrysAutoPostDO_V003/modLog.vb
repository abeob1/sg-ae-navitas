...
Module modLog
    ...
    Function ExecuteSQLQuery_DT(ByVal sQuery As String, ByRef sErrDesc As String) As DataTable
        ...
        Try
            ...
            oConnection = New SqlConnection(p_sSAPConnString)
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            ExecuteSQLQuery_DT = oDT_INTDBInformations

        Catch ex As Exception
            Call WriteToLogFile(ex.Message, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            ExecuteSQLQuery_DT = Nothing
        Finally
            oSQLAdapter.Dispose()
            oSQLCommand.Dispose()
            oConnection.Close()
